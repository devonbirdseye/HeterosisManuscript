...
#limit to genes detected as proteins
cpm.6H.all6 <- cpm.6H.all6[cpm.6H.all6$Gene%in%cpm.6H.all6$Gene,]
#save
...
#limit to genes detected as protein
cpm.RIL.all9 <- cpm.RIL.all9[cpm.RIL.all9$Gene%in%tmt.ril.SL$Gene,]
#save
...
#Define settings functions for plotting
```{r get_legend}
