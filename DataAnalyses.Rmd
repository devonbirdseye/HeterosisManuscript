...
#Import protein data
tmt <- read.csv(paste0(PathToData,"SupplementalTable11.csv"), stringsAsFactors = F)
...
#6-hybrid experiment
cpm.6H <- read.csv(paste0(PathToData, "SupplementalTable12.csv"), stringsAsFactors = F)
#RIL experiment
cpm.RIL <- read.csv(paste0(PathToData, "SupplementalTable13.csv"), stringsAsFactors = F)
```
...
mgdb <- read.csv(paste0(PathToData,"SupplementalTable10.csv"), stringsAsFactors = F, header = F)
...
KEGG.zma00195 <- read.csv(paste0(PathToData, "SupplementalTable6.csv"), stringsAsFactors = F)
#Get v4 accessions
...
```{r KEGG.zma00196}
#Retrieved from KEGG on 02/26/2020
KEGG.zma00196 <- read.csv(paste0(PathToData, "SupplementalTable7.csv"), stringsAsFactors = F)
#Get v4 accessions
...
CornCycLightRxns.digenomic <- read.csv(paste0(PathToData, "SupplementalTable8.csv"), stringsAsFactors = F)
```
...
CornCycEtBio <- read.csv(paste0(PathToData, "SupplementalTable9.csv"), stringsAsFactors = F)
