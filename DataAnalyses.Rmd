...
fs2$l2.B73xMo17.MP.x[fs2$l2.B73xMo17.MP.x <= -1] <- -1
fs2$l2.B73xMo17.MP.x[fs2$l2.B73xMo17.MP.x >= 1] <- 1
fs2$l2.B73xMo17.MP.y[fs2$l2.B73xMo17.MP.y <= -1] <- -1
fs2$l2.B73xMo17.MP.y[fs2$l2.B73xMo17.MP.y >= 1] <- 1
fs2$l2.B73.Mo17.x[fs2$l2.B73.Mo17.x <= -1] <- -1
fs2$l2.B73.Mo17.x[fs2$l2.B73.Mo17.x >= 1] <- 1
fs2$l2.B73.Mo17.y[fs2$l2.B73.Mo17.y <= -1] <- -1
fs2$l2.B73.Mo17.y[fs2$l2.B73.Mo17.y >= 1] <- 1
#Set GOIs
fs2 <- fs2
fs2$Category <- "Other"
