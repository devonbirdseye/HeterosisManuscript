...
tmt.SL <- tmt[,c(171:176,181:183,12:20)]
#Remove proteins not detected in one or more samples
tmt.SL <- na.omit(tmt.SL)
#Calculate averages of bio reps
tmt.SL$B73avg <- rowMeans(tmt.SL[,10:12])
tmt.SL$Mo17avg <- rowMeans(tmt.SL[,13:15])
tmt.SL$HYBavg <- rowMeans(tmt.SL[,16:18])
tmt.SL$MPavg <- rowMeans(tmt.SL[,c(10:15)])
#calculate ratios
...
tmt.DN <- tmt[,c(171:176,181:183,62:70)]
#Remove proteins not detected in one or more samples
tmt.DN <- na.omit(tmt.DN)
#Calculate averages of bio reps
tmt.DN$B73avg <- rowMeans(tmt.DN[,10:12])
tmt.DN$Mo17avg <- rowMeans(tmt.DN[,13:15])
tmt.DN$HYBavg <- rowMeans(tmt.DN[,16:18])
tmt.DN$MPavg <- rowMeans(tmt.DN[,c(10:15)])
#calculate ratios
...
#BxM from Original Experiment (OG)
tmt.LB <- tmt[,c(171:176,181:183,22:30)]
#Remove proteins not detected in one or more samples
tmt.LB <- na.omit(tmt.LB)
#Calculate averages of bio reps
tmt.LB$B73avg <- rowMeans(tmt.LB[,10:12])
tmt.LB$Mo17avg <- rowMeans(tmt.LB[,13:15])
tmt.LB$HYBavg <- rowMeans(tmt.LB[,16:18])
tmt.LB$MPavg <- rowMeans(tmt.LB[,c(10:15)])
#calculate ratios
...
tmt.DN.both <- tmt[,c(171:176,181:183,62:70,72:80)]
#Remove proteins not detected in one or more samples
tmt.DN.both <- na.omit(tmt.DN.both)
#Calculate averages of bio reps
tmt.DN.both$day.B73avg <- rowMeans(tmt.DN.both[,10:12])
tmt.DN.both$day.Mo17avg <- rowMeans(tmt.DN.both[,13:15])
tmt.DN.both$day.HYBavg <- rowMeans(tmt.DN.both[,16:18])
tmt.DN.both$day.MPavg <- rowMeans(tmt.DN.both[,c(10:15)])

tmt.DN.both$night.B73avg <- rowMeans(tmt.DN.both[,19:21])
tmt.DN.both$night.Mo17avg <- rowMeans(tmt.DN.both[,22:24])
tmt.DN.both$night.HYBavg <- rowMeans(tmt.DN.both[,25:27])
tmt.DN.both$night.MPavg <- rowMeans(tmt.DN.both[,c(19:24)])
#calculate ratios
...
tmt.6H <- tmt[,c(171:176,181:183,31:60)]
#Remove proteins not detected in one or more samples
tmt.6H <- na.omit(tmt.6H)
#calculate averages
tmt.6H$B73 <- rowMeans(tmt.6H[,c(10,20,30)])
tmt.6H$Mo17 <- rowMeans(tmt.6H[,c(12,22,32)])
tmt.6H$B73xMo17 <- rowMeans(tmt.6H[,c(14,24,34)])
tmt.6H$Mo17xB73 <- rowMeans(tmt.6H[,c(15,25,35)])
tmt.6H$B84 <- rowMeans(tmt.6H[,c(11,21,31)])
tmt.6H$B84xB73 <- rowMeans(tmt.6H[,c(16,26,36)])
tmt.6H$B84xMo17 <- rowMeans(tmt.6H[,c(17,27,37)])
tmt.6H$A682 <- rowMeans(tmt.6H[,c(13,23,33)])
tmt.6H$A682xB73 <- rowMeans(tmt.6H[,c(18,28,38)])
tmt.6H$A682xMo17 <- rowMeans(tmt.6H[,c(19,29,39)])
...
tmt.RIL$M0014.B73 <- rowMeans(tmt.RIL[,20:23])
tmt.RIL$M0014.Mo17<- rowMeans(tmt.RIL[,24:27])
tmt.RIL$M0014.14 <- rowMeans(tmt.RIL[,28:31])
tmt.RIL$M0014.14B <- rowMeans(tmt.RIL[,32:35])
tmt.RIL$M0014.14M <- rowMeans(tmt.RIL[,36:39])
tmt.RIL$M0016.B73 <- rowMeans(tmt.RIL[,40:43])
tmt.RIL$M0016.Mo17<- rowMeans(tmt.RIL[,44:47])
tmt.RIL$M0016.16 <- rowMeans(tmt.RIL[,48:51])
tmt.RIL$M0016.16B <- rowMeans(tmt.RIL[,52:55])
tmt.RIL$M0016.16M <- rowMeans(tmt.RIL[,56:59])
tmt.RIL$M0021.B73 <- rowMeans(tmt.RIL[,60:63])
tmt.RIL$M0021.Mo17<- rowMeans(tmt.RIL[,64:67])
tmt.RIL$M0021.21 <- rowMeans(tmt.RIL[,68:71])
tmt.RIL$M0021.21B <- rowMeans(tmt.RIL[,72:75])
tmt.RIL$M0021.21M <- rowMeans(tmt.RIL[,76:79])
tmt.RIL$M0317.B73 <- rowMeans(tmt.RIL[,80:83])
tmt.RIL$M0317.Mo17<- rowMeans(tmt.RIL[,84:87])
tmt.RIL$M0317.317 <- rowMeans(tmt.RIL[,88:91])
tmt.RIL$M0317.317B <- rowMeans(tmt.RIL[,92:95])
tmt.RIL$M0317.317M <- rowMeans(tmt.RIL[,96:99])
#Calculate hyb/mp ratios
tmt.RIL$BM.BM.MP <- tmt.RIL$BM.BM/rowMeans(tmt.RIL[,100:101], na.rm = T)
tmt.RIL$M0014.14B.MP <- tmt.RIL$M0014.14B/rowMeans(tmt.RIL[,c(103,105)], na.rm = T)
tmt.RIL$M0014.14M.MP <- tmt.RIL$M0014.14M/rowMeans(tmt.RIL[,c(104,105)], na.rm = T)
tmt.RIL$M0016.16B.MP <- tmt.RIL$M0016.16B/rowMeans(tmt.RIL[,c(108,110)], na.rm = T)
tmt.RIL$M0016.16M.MP <- tmt.RIL$M0016.16M/rowMeans(tmt.RIL[,c(109,110)], na.rm = T)
tmt.RIL$M0021.21B.MP <- tmt.RIL$M0021.21B/rowMeans(tmt.RIL[,c(113,115)], na.rm = T)
tmt.RIL$M0021.21M.MP <- tmt.RIL$M0021.21M/rowMeans(tmt.RIL[,c(114,115)], na.rm = T)
tmt.RIL$M0317.317B.MP <- tmt.RIL$M0317.317B/rowMeans(tmt.RIL[,c(118,120)], na.rm = T)
tmt.RIL$M0317.317M.MP <- tmt.RIL$M0317.317M/rowMeans(tmt.RIL[,c(119,120)], na.rm = T)
#Calculate parent/parent ratios
...
cpm.SL.protein <- cpm.SL
cpm.SL.protein <- cpm.SL.protein[cpm.SL.protein$Gene%in%tmt.SL$Gene,]
```
...
##Remove genes that weren't detected as protein
cpm.LB.protein <- cpm.LB
cpm.LB.protein <- cpm.LB.protein[cpm.LB.protein$Gene%in%tmt.LB$Gene,]
```
...
#Calculate averages
cpm.6H$B73 <- rowMeans(cpm.6H[,2:4], na.rm = T)
cpm.6H$B84 <- rowMeans(cpm.6H[,5:7], na.rm = T)
cpm.6H$Mo17 <- rowMeans(cpm.6H[,8:10], na.rm = T)
cpm.6H$A682 <- rowMeans(cpm.6H[,11:13], na.rm = T)
cpm.6H$B73xMo17 <- rowMeans(cpm.6H[,14:16], na.rm = T)
cpm.6H$Mo17xB73 <- rowMeans(cpm.6H[,17:19], na.rm = T)
cpm.6H$B84xB73 <- rowMeans(cpm.6H[,20:22], na.rm = T)
cpm.6H$B84xMo17 <- rowMeans(cpm.6H[,23:25], na.rm = T)
cpm.6H$A682xB73 <- rowMeans(cpm.6H[,26:28], na.rm = T)
cpm.6H$A682xMo17 <- rowMeans(cpm.6H[,29:31], na.rm = T)
...
##Remove genes that weren't detected as protein
cpm.6H.protein <- cpm.6H
cpm.6H.protein <- cpm.6H.protein[cpm.6H.protein$Gene%in%tmt.6H$Gene,]
```
...
#Calculate averages
cpm.RIL$B73 <- rowMeans(cpm.RIL[,2:5], na.rm = T)
cpm.RIL$B73xMo17 <- rowMeans(cpm.RIL[,c(6:8,60)], na.rm = T)
cpm.RIL$Mo17 <- rowMeans(cpm.RIL[,56:59], na.rm = T)
cpm.RIL$M0014 <- rowMeans(cpm.RIL[,9:12], na.rm = T)
cpm.RIL$M0014xB73 <- rowMeans(cpm.RIL[,13:16], na.rm = T)
cpm.RIL$M0014xMo17 <- rowMeans(cpm.RIL[,17:20], na.rm = T)
cpm.RIL$M0016 <- rowMeans(cpm.RIL[,21:24], na.rm = T)
cpm.RIL$M0016xB73 <- rowMeans(cpm.RIL[,25:27], na.rm = T)
cpm.RIL$M0016xMo17 <- rowMeans(cpm.RIL[,28:31], na.rm = T)
cpm.RIL$M0021 <- rowMeans(cpm.RIL[,32:35], na.rm = T)
cpm.RIL$M0021xB73 <- rowMeans(cpm.RIL[,36:39], na.rm = T)
cpm.RIL$M0021xMo17 <- rowMeans(cpm.RIL[,40:43], na.rm = T)
cpm.RIL$M0317 <- rowMeans(cpm.RIL[,44:47], na.rm = T)
cpm.RIL$M0317xB73 <- rowMeans(cpm.RIL[,48:51], na.rm = T)
cpm.RIL$M0317xMo17 <- rowMeans(cpm.RIL[,52:55], na.rm = T)
#calculate ratio of hybrid to midparent
...
```
```{r}
write.csv(PlantHeights.RIL, "PlantHeights.RIL.csv", row.names = F)
write.csv(PlantHeights.6H, "PlantHeights.6H.csv", row.names = F)
```

#New plant height data
```{r}
PlantHeights.RIL.new <- read.csv("Data/RILPlantHeightsNew.csv", stringsAsFactors = F)
```
```{r}
PlantHeights.RIL.new$avg <- rowMeans(PlantHeights.RIL.new[,5:14])

PlantHeights.RIL.new.EN <- PlantHeights.RIL.new[PlantHeights.RIL.new$Height.type=="Ear node",]
PlantHeights.RIL.new.FL <- PlantHeights.RIL.new[PlantHeights.RIL.new$Height.type=="Flag leaf",]
PlantHeights.RIL.new.TT <- PlantHeights.RIL.new[PlantHeights.RIL.new$Height.type=="Tassel tip",]
```

```{r}
PlantHeights.RIL.new.EN <- (PlantHeights.RIL.new.EN[,c(2,3,15)])
PlantHeights.RIL.new.EN <- dcast(PlantHeights.RIL.new.EN, Genotype ~ Rep)

PlantHeights.RIL.new.FL <- (PlantHeights.RIL.new.FL[,c(2,3,15)])
PlantHeights.RIL.new.FL <- dcast(PlantHeights.RIL.new.FL, Genotype ~ Rep)

PlantHeights.RIL.new.TT <- (PlantHeights.RIL.new.TT[,c(2,3,15)])
PlantHeights.RIL.new.TT <- dcast(PlantHeights.RIL.new.TT, Genotype ~ Rep)
```
```{r}
library(matrixStats)
```
...
```{r}
PlantHeights.RIL.new.EN$avg <- rowMeans(PlantHeights.RIL.new.EN[,2:5], na.rm = T)
PlantHeights.RIL.new.EN$sd <- rowSds(as.matrix(PlantHeights.RIL.new.EN[,2:5]), na.rm = T)

PlantHeights.RIL.new.FL$avg <- rowMeans(PlantHeights.RIL.new.FL[,2:5], na.rm = T)
PlantHeights.RIL.new.FL$sd <- rowSds(as.matrix(PlantHeights.RIL.new.FL[,2:5]), na.rm = T)

PlantHeights.RIL.new.TT$avg <- rowMeans(PlantHeights.RIL.new.TT[,2:5], na.rm = T)
PlantHeights.RIL.new.TT$sd <- rowSds(as.matrix(PlantHeights.RIL.new.TT[,2:5]), na.rm = T)
```

```{r}
mean(PlantHeights.RIL.new.EN$sd)
mean(PlantHeights.RIL.new.FL$sd)
mean(PlantHeights.RIL.new.TT$sd)
```
```{r}
PlantHeights.RIL.new.EN.ratios <- PlantHeights.RIL.new.EN
PlantHeights.RIL.new.EN.ratios <- PlantHeights.RIL.new.EN.ratios[,c("Genotype", "avg")]
PlantHeights.RIL.new.EN.ratios <- transpose(PlantHeights.RIL.new.EN.ratios)
colnames(PlantHeights.RIL.new.EN.ratios) <- c("B73", "B73xMo17", "M0014", "M0014xB73", "M0014xMo17", "M0016", "M0016xB73", "M0016xMo17", "M0021", "M0021xB73", "M0021xMo17", "M0317", "M0317xB73", "M0317xMo17", "Mo17", "Mo17xB73")
PlantHeights.RIL.new.EN.ratios <- as.data.frame(sapply(PlantHeights.RIL.new.EN.ratios, as.numeric))
PlantHeights.RIL.new.EN.ratios <- PlantHeights.RIL.new.EN.ratios[-1,]
#Calculate hyb/MP ratios
PlantHeights.RIL.new.EN.ratios$B73xMo17.MP <- PlantHeights.RIL.new.EN.ratios$B73xMo17/rowMeans(PlantHeights.RIL.new.EN.ratios[,c("B73", "Mo17")])
PlantHeights.RIL.new.EN.ratios$M0014xB73.MP <- PlantHeights.RIL.new.EN.ratios$M0014xB73/rowMeans(PlantHeights.RIL.new.EN.ratios[,c("B73", "M0014")])
PlantHeights.RIL.new.EN.ratios$M0014xMo17.MP <- PlantHeights.RIL.new.EN.ratios$M0014xMo17/rowMeans(PlantHeights.RIL.new.EN.ratios[,c("Mo17", "M0014")])
PlantHeights.RIL.new.EN.ratios$M0016xB73.MP <- PlantHeights.RIL.new.EN.ratios$M0016xB73/rowMeans(PlantHeights.RIL.new.EN.ratios[,c("B73", "M0016")])
PlantHeights.RIL.new.EN.ratios$M0016xMo17.MP <- PlantHeights.RIL.new.EN.ratios$M0016xMo17/rowMeans(PlantHeights.RIL.new.EN.ratios[,c("Mo17", "M0016")])
PlantHeights.RIL.new.EN.ratios$M0021xB73.MP <- PlantHeights.RIL.new.EN.ratios$M0021xB73/rowMeans(PlantHeights.RIL.new.EN.ratios[,c("B73", "M0021")])
PlantHeights.RIL.new.EN.ratios$M0021xMo17.MP <- PlantHeights.RIL.new.EN.ratios$M0021xMo17/rowMeans(PlantHeights.RIL.new.EN.ratios[,c("Mo17", "M0021")])
PlantHeights.RIL.new.EN.ratios$M0317xB73.MP <- PlantHeights.RIL.new.EN.ratios$M0317xB73/rowMeans(PlantHeights.RIL.new.EN.ratios[,c("B73", "M0317")])
PlantHeights.RIL.new.EN.ratios$M0317xMo17.MP <- PlantHeights.RIL.new.EN.ratios$M0317xMo17/rowMeans(PlantHeights.RIL.new.EN.ratios[,c("Mo17", "M0317")])
#Calculate hybrid/BxM ratios
PlantHeights.RIL.new.EN.ratios$B73xMo17.BxM <- PlantHeights.RIL.new.EN.ratios$B73xMo17/PlantHeights.RIL.new.EN.ratios$B73xMo17
PlantHeights.RIL.new.EN.ratios$M0014xB73.BxM <- PlantHeights.RIL.new.EN.ratios$M0014xB73/PlantHeights.RIL.new.EN.ratios$B73xMo17
PlantHeights.RIL.new.EN.ratios$M0014xMo17.BxM <- PlantHeights.RIL.new.EN.ratios$M0014xMo17/PlantHeights.RIL.new.EN.ratios$B73xMo17
PlantHeights.RIL.new.EN.ratios$M0016xB73.BxM <- PlantHeights.RIL.new.EN.ratios$M0016xB73/PlantHeights.RIL.new.EN.ratios$B73xMo17
PlantHeights.RIL.new.EN.ratios$M0016xMo17.BxM <- PlantHeights.RIL.new.EN.ratios$M0016xMo17/PlantHeights.RIL.new.EN.ratios$B73xMo17
PlantHeights.RIL.new.EN.ratios$M0021xB73.BxM <- PlantHeights.RIL.new.EN.ratios$M0021xB73/PlantHeights.RIL.new.EN.ratios$B73xMo17
PlantHeights.RIL.new.EN.ratios$M0021xMo17.BxM <- PlantHeights.RIL.new.EN.ratios$M0021xMo17/PlantHeights.RIL.new.EN.ratios$B73xMo17
PlantHeights.RIL.new.EN.ratios$M0317xB73.BxM <- PlantHeights.RIL.new.EN.ratios$M0317xB73/PlantHeights.RIL.new.EN.ratios$B73xMo17
PlantHeights.RIL.new.EN.ratios$M0317xMo17.BxM <- PlantHeights.RIL.new.EN.ratios$M0317xMo17/PlantHeights.RIL.new.EN.ratios$B73xMo17
```
```{r}
PlantHeights.ril.MP.new <- as.numeric(PlantHeights.RIL.new.EN.ratios[1,17:25])
PlantHeights.ril.BxM.new <- as.numeric(PlantHeights.RIL.new.EN.ratios[1,26:34])
colnames(PlantHeights.RIL.new.EN.ratios)
```
...
for(i in 1:nrow(tmt.SL)){
  tmt.SL[i,"CV"] <- cv(as.numeric(tmt.SL[i,16:18]))
}
tmt.6H$CV <- NA
for(i in 1:nrow(tmt.6H)){
  tmt.6H[i,"CV"] <- cv(as.numeric(tmt.6H[i,c(14,24,34)]))
}
tmt.RIL$CV <- NA
for(i in 1:nrow(tmt.RIL)){
  tmt.RIL[i,"CV"] <- cv(as.numeric(tmt.RIL[i,16:19]))
}
#RNA CV
##Calculate CV
cpm.SL.protein$CV <- NA
for(i in 1:nrow(cpm.SL.protein)){
  cpm.SL.protein[i,"CV"] <- cv(as.numeric(cpm.SL.protein[i,8:10]))
}
cpm.6H.protein$CV <- NA
for(i in 1:nrow(cpm.6H.protein)){
  cpm.6H.protein[i,"CV"] <- cv(as.numeric(cpm.6H.protein[i,14:16]))
}
cpm.RIL.protein$CV <- NA
for(i in 1:nrow(cpm.RIL.protein)){
  cpm.RIL.protein[i,"CV"] <- cv(as.numeric(cpm.RIL.protein[i,c(6:8,60)]))
}
...
#subset hybrids
tmt.6h.b73xmo17 <- tmt.6H[,c(1:9,62,68)]
tmt.6h.mo17xb73 <- tmt.6H[,c(1:9,63,69)]
tmt.6h.b84xb73 <- tmt.6H[,c(1:9,64,70)]
tmt.6h.b84xmo17 <- tmt.6H[,c(1:9,65,71)]
tmt.6h.a682xb73 <- tmt.6H[,c(1:9,66,72)]
tmt.6h.a682xmo17<- tmt.6H[,c(1:9,67,73)]
#rename columns
...
#subset RIL hybrids
tmt.RIL.Hyb2BxM <- tmt.RIL[,c(6,100:122)]
...
#subset 6-hybrid
tmt.6H.Hyb2BxM <- tmt.6H[,c(6,40:49)]
...
#subset RIL hybrids
tmt.RIL.Hyb2MP <- tmt.RIL[,c(6,123:131)]
#subset 6-hybrid
tmt.6H.Hyb2MP <- tmt.6H[,c(6,50:55)]
#combine RIL and 6 hybrids
...
tmt.RIL.6H.Hyb2MP <- merge.data.frame(tmt.RIL[,c(6,123:131)], tmt.6H[,c(6,50:55)], by.x = "Accession", by.y = "Accession", all = F)
...
```
```{r}
tmt.RIL.6H.Hyb2MP.cor$Gene <- substr(tmt.RIL.6H.Hyb2MP.cor$Accession, start = 1, stop = 14)
write.csv(tmt.RIL.6H.Hyb2MP.cor[,c("Gene", "Accession", "cor")], "tmt.RIL.6H.Hyb2MP.cor.csv", row.names = F)
write.csv(cpm.RIL.6H.Hyb2MP.cor[,c("Gene", "cor")], "cpm.RIL.6H.Hyb2MP.cor.csv", row.names = F)
```
...
```{r}
tmt.RIL.Hyb2MP <- tmt.RIL[,c(6,123:131,9)]
tmt.6H.Hyb2MP <-tmt.6H[,c(6,50:55, 9)]
tmt.RIL.6H.Hyb2MP <- merge.data.frame(tmt.RIL[,c(6,123:131)], tmt.6H[,c(6,50:55)], by.x = "Accession", by.y = "Accession", all = F)
...
```
```{r}
write.csv(tmt.RIL.6H.Hyb2MP.cor[order(-tmt.RIL.6H.Hyb2MP.cor$cor),c(1,17,19)], "tmt.RIL.6H.Hyb2MP.cor.csv", row.names = F)
```
...
tmt.6H.cor <- CorFun(tmt.6H, 62:67, PlantHeights.6h.MP)
tmt.RIL.cor <- CorFun(tmt.RIL, 141:149, PlantHeights.ril.MP)
...
tmt.cor <- merge.data.frame(tmt.cor, mgdb[,c(1,12)], by.x = "Gene", by.y = "v4_gene_model", all.x = T, all.y = F)
tmt.cor$GOI <- "Other"
tmt.cor$Order <- 1
...
```{r}
tmt.6H.Hyb2MP.Par2Par <- tmt.6H[,c(6,62:73)]
tmt.RIL.Hyb2MP.Par2Par <- tmt.RIL[,c(6,141:158)]
...
mean(tmt.cpm.RIL.6H.Hyb2MP.cor2$cor[tmt.cpm.RIL.6H.Hyb2MP.cor2$Gene %in% PhANGs])
```

```{r}
colnames(tmt.cpm.RIL.6H.Hyb2MP.cor2)
```
